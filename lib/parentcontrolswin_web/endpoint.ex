defmodule ParentcontrolswinWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :parentcontrolswin
  ...
  @session_options [
    store: :cookie,
    key: "_parentcontrolswin_key",
    signing_salt: "v5SqEnLi",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    at: "/",
    from: :parentcontrolswin,
    gzip: false,
    only: ParentcontrolswinWeb.static_paths()
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :parentcontrolswin
  end
  ...
  plug Stripe.WebhookPlug,
    at: "/webhook/stripe",
    handler: ParentcontrolswinWeb.StripeHandler,
