defmodule Parentcontrolswin.Users.User do
  ...
  schema "users" do
    pow_user_fields()
    field :content_filters, :string, default: "nsfw,lgbt,trans,atheism,drug,weed,alcohol,tobacco,antiwork,antiparent,shortvideo,safesearch,nonmonogamy,suicide,communism"
